...
class ConsultaRecoleccion extends Model
{
  ...
  public function obtenerGenero($option){
    if($option == "general"){
      ...
      $h_query  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.genero')->where('participacion.genero',1)->where('participacion.municipio_residencia',$option)->count();
      $m_query  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.genero')->where('participacion.genero',2)->where('participacion.municipio_residencia',$option)->count();
      $o_query  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.genero')->where('participacion.genero',3)->where('participacion.municipio_residencia',$option)->count();
    }
  ...
  public function obtenerOcupacion($option){
    ...
    if($option == "general"){
      ...
      $o_estudiante = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ocupacion')->where('participacion.municipio_residencia',$option)->where('participacion.ocupacion','estudiante')->count();
      $o_empleado = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ocupacion')->where('participacion.municipio_residencia',$option)->where('participacion.ocupacion','empleado')->count();
      $o_independiente = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ocupacion')->where('participacion.municipio_residencia',$option)->where('participacion.ocupacion','independiente')->count();
      $o_desempleado= \DB::table('participaciones_recoleccion as participacion')->select('participacion.ocupacion')->where('participacion.municipio_residencia',$option)->where('participacion.ocupacion','desempleado')->count();
      $o_hogar = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ocupacion')->where('participacion.municipio_residencia',$option)->where('participacion.ocupacion','hogar')->count();
  ...
  public function obtenerDiscapacidad($option){
    ...
    if($option == "general"){
      ...
      $d_si = \DB::table('participaciones_recoleccion as participacion')->select('participacion.discapacidad')->where('participacion.municipio_residencia',$option)->where('participacion.discapacidad',1)->count();
      $d_no = \DB::table('participaciones_recoleccion as participacion')->select('participacion.discapacidad')->where('participacion.municipio_residencia',$option)->where('participacion.discapacidad',0)->count();
    }
  ...
  public function obtenerNivelEducativo($option){
    ...
    if($option == "general"){
      ...
      $n_e_primaria = \DB::table('participaciones_recoleccion as participacion')->select('participacion.nivel_educativo')->where('participacion.municipio_residencia',$option)->where('participacion.nivel_educativo','primaria')->count();
      $n_e_secundaria = \DB::table('participaciones_recoleccion as participacion')->select('participacion.nivel_educativo')->where('participacion.municipio_residencia',$option)->where('participacion.nivel_educativo','secundaria')->count();
      $n_e_tecnica = \DB::table('participaciones_recoleccion as participacion')->select('participacion.nivel_educativo')->where('participacion.municipio_residencia',$option)->where('participacion.nivel_educativo','tecnica')->count();
      $n_e_universitaria = \DB::table('participaciones_recoleccion as participacion')->select('participacion.nivel_educativo')->where('participacion.municipio_residencia',$option)->where('participacion.nivel_educativo','universitaria')->count();
      $n_e_ninguna = \DB::table('participaciones_recoleccion as participacion')->select('participacion.nivel_educativo')->where('participacion.municipio_residencia',$option)->where('participacion.nivel_educativo','ninguna')->count();
  ...
  public function obtenerRegimenSalud($option){
    ...
    if($option == "general"){
      ...
      $count_subsidiado  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.regimen_salud')->where('participacion.municipio_residencia',$option)->where('participacion.regimen_salud','subsidiado')->count();
      $count_contributivo  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.regimen_salud')->where('participacion.municipio_residencia',$option)->where('participacion.regimen_salud','contributivo')->count();
    }
  ...
  public function obtenerSector($option){
    ...
    if($option == "general"){
      ...
      $count_rural  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector')->where('participacion.municipio_residencia',$option)->where('participacion.sector',1)->count();
      $count_urbano  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector')->where('participacion.municipio_residencia',$option)->where('participacion.sector',2)->count();
    }
  ...
  public function obtenerEstrato($option){
    ...
    if($option == "general"){
      ...
      $count_1  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.estrato_socio_economico')->where('participacion.municipio_residencia',$option)->where('participacion.estrato_socio_economico',1)->count();
      $count_2  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.estrato_socio_economico')->where('participacion.municipio_residencia',$option)->where('participacion.estrato_socio_economico',2)->count();
      $count_3  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.estrato_socio_economico')->where('participacion.municipio_residencia',$option)->where('participacion.estrato_socio_economico',3)->count();
      $count_4  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.estrato_socio_economico')->where('participacion.municipio_residencia',$option)->where('participacion.estrato_socio_economico',4)->count();
      $count_5  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.estrato_socio_economico')->where('participacion.municipio_residencia',$option)->where('participacion.estrato_socio_economico',5)->count();
      $count_6  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.estrato_socio_economico')->where('participacion.municipio_residencia',$option)->where('participacion.estrato_socio_economico',6)->count();
    }
  ...
  public function obtenerSalidoDepartamento($option){
    ...
    if($option == "general"){
      ...
      $count_si  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ha_salido_departamento')->where('participacion.municipio_residencia',$option)->where('participacion.ha_salido_departamento',1)->count();
      $count_no  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ha_salido_departamento')->where('participacion.municipio_residencia',$option)->where('participacion.ha_salido_departamento',0)->count();
    }
  ...
  public function obtenerSalidoMunicipio($option){
    if($option == "general"){
      ...
      $count_si_m  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ha_salido_municipio')->where('participacion.municipio_residencia',$option)->where('participacion.ha_salido_municipio',1)->count();
      $count_no_m  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.ha_salido_municipio')->where('participacion.municipio_residencia',$option)->where('participacion.ha_salido_municipio',0)->count();
    }
  ...
  public function obtenerActores($option){
    ...
    if($option == "general"){
      ...
      $count_ninguno  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Ninguno')->count();
      $count_transporte  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Transporte y vías')->count();
      $count_infraestructura  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Infraestructura y servicios públicos')->count();
      $count_gremios  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Gremios')->count();
      $count_ambiente  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Medio ambiente y desarrollo')->count();
    }
  ...
  public function obtenerCondicionesFisicas($option){
    ...
    if($option == "general"){
      ...
      $count_material  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.condiciones_fisicas')->where('participacion.municipio_residencia',$option)->where('participacion.condiciones_fisicas','material')->count();
      $count_palafitica  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.condiciones_fisicas')->where('participacion.municipio_residencia',$option)->where('participacion.condiciones_fisicas','palafitica')->count();
      $count_bareque  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.condiciones_fisicas')->where('participacion.municipio_residencia',$option)->where('participacion.condiciones_fisicas','bareque')->count();
    }
  ...
  public function obtenerViviendaEs($option){
    ...
    if($option == "general"){
      ...
      $count_familiar  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_es')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_es','familiar')->count();
      $count_arrendada  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_es')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_es','arrendada')->count();
      $count_propia  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_es')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_es','propia')->count();
    }
  ...
  public function obtenerServicios($option){
    ...
    if($option == "general"){
        ...
        $count_agua_si  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_agua_potable')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_agua_potable','si')->count();
        $count_agua_no  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_agua_potable')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_agua_potable','no')->count();
        $count_alcantarillado_si  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_alcantarillado')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_alcantarillado','si')->count();
        $count_alcantarillado_no  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_alcantarillado')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_alcantarillado','no')->count();
        $count_energia_si  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_energia')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_energia','si')->count();
        $count_energia_no  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_energia')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_energia','no')->count();
        $count_gas_si  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_gas')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_gas','si')->count();
        $count_gas_no  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_gas')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_gas','no')->count();
        $count_recoleccion_si  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_recoleccion_basura')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_recoleccion_basura','si')->count();
        $count_recoleccion_no  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.vivienda_cuenta_recoleccion_basura')->where('participacion.municipio_residencia',$option)->where('participacion.vivienda_cuenta_recoleccion_basura','no')->count();
    }
  ...
  public function obtenerSuelo($option){
    ...
    if($option == "general"){
      $count_vivienda1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vivienda')->where('participacion.ms_vivienda',1)->count();
      $count_vivienda0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vivienda')->where('participacion.ms_vivienda',0)->count();
      $count_comercio1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_comercio')->where('participacion.ms_comercio',1)->count();
      $count_comercio0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.mas_suelo_para')->where('participacion.ms_comercio',0)->count();
      $count_conservacion1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_conservacion')->where('participacion.ms_conservacion',1)->count();
      $count_conservacion0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_conservacion')->where('participacion.ms_conservacion',0)->count();
      $count_proteccion1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_proteccion')->where('participacion.ms_proteccion',1)->count();
      $count_proteccion0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_proteccion')->where('participacion.ms_proteccion',0)->count();
      $count_agricultura1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_agricultura')->where('participacion.ms_agricultura',1)->count();
      $count_agricultura0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_agricultura')->where('participacion.ms_agricultura',0)->count();
      $count_ganaderia1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_ganaderia')->where('participacion.ms_ganaderia',1)->count();
      $count_ganaderia0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_ganaderia')->where('participacion.ms_ganaderia',0)->count();
      $count_mineria1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_mineria')->where('participacion.ms_mineria',1)->count();
      $count_mineria0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_mineria')->where('participacion.ms_mineria',0)->count();
      $count_industria1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_industria')->where('participacion.ms_industria',1)->count();
      $count_industria0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_industria')->where('participacion.ms_industria',0)->count();
      $count_vias1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vias')->where('participacion.ms_vias',1)->count();
      $count_vias0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vias')->where('participacion.ms_vias',0)->count();
    }else{
      $count_vivienda1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vivienda')->where('participacion.municipio_residencia',$option)->where('participacion.ms_vivienda',1)->count();
      $count_vivienda0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vivienda')->where('participacion.municipio_residencia',$option)->where('participacion.ms_vivienda',0)->count();
      $count_comercio1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_comercio')->where('participacion.municipio_residencia',$option)->where('participacion.ms_comercio',1)->count();
      $count_comercio0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.mas_suelo_para')->where('participacion.municipio_residencia',$option)->where('participacion.ms_comercio',0)->count();
      $count_conservacion1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_conservacion')->where('participacion.municipio_residencia',$option)->where('participacion.ms_conservacion',1)->count();
      $count_conservacion0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_conservacion')->where('participacion.municipio_residencia',$option)->where('participacion.ms_conservacion',0)->count();
      $count_proteccion1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_proteccion')->where('participacion.municipio_residencia',$option)->where('participacion.ms_proteccion',1)->count();
      $count_proteccion0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_proteccion')->where('participacion.municipio_residencia',$option)->where('participacion.ms_proteccion',0)->count();
      $count_agricultura1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_agricultura')->where('participacion.municipio_residencia',$option)->where('participacion.ms_agricultura',1)->count();
      $count_agricultura0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_agricultura')->where('participacion.municipio_residencia',$option)->where('participacion.ms_agricultura',0)->count();
      $count_ganaderia1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_ganaderia')->where('participacion.municipio_residencia',$option)->where('participacion.ms_ganaderia',1)->count();
      $count_ganaderia0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_ganaderia')->where('participacion.municipio_residencia',$option)->where('participacion.ms_ganaderia',0)->count();
      $count_mineria1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_mineria')->where('participacion.municipio_residencia',$option)->where('participacion.ms_mineria',1)->count();
      $count_mineria0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_mineria')->where('participacion.municipio_residencia',$option)->where('participacion.ms_mineria',0)->count();
      $count_industria1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_industria')->where('participacion.municipio_residencia',$option)->where('participacion.ms_industria',1)->count();
      $count_industria0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_industria')->where('participacion.municipio_residencia',$option)->where('participacion.ms_industria',0)->count();
      $count_vias1  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vias')->where('participacion.municipio_residencia',$option)->where('participacion.ms_vias',1)->count();
      $count_vias0  = \DB::table('participaciones_recoleccion_recoleccion as participacion')->select('participacion.ms_vias')->where('participacion.municipio_residencia',$option)->where('participacion.ms_vias',0)->count();
    }
  ...
  public function obtenerVariablesAmbientales($option){
    ...
    if($option == "general"){
      ...
      $c_count01  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',1)->count();
      $c_count02  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',2)->count();
      $c_count03  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',3)->count();
      $c_count04  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',4)->count();
      $c_count05  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',5)->count();
      $c_count06  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',6)->count();
      $c_count07  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',7)->count();
      $c_count08  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',8)->count();
      $c_count09  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',9)->count();
      $c_count10  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',10)->count();
      $c_count11  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',11)->count();
      $c_count12  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_ambiental')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_ambiental',12)->count();
  ...
  public function obtenerVariablesSocial($option){
    ...
    if($option == "general"){
      ...
      $c_count13  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',13)->count();
      $c_count14  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',14)->count();
      $c_count15  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',15)->count();
      $c_count16  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',16)->count();
      $c_count17  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',17)->count();
      $c_count18  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',18)->count();
      $c_count19  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',19)->count();
      $c_count20  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',20)->count();
      $c_count21  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',21)->count();
      $c_count22  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',22)->count();
      $c_count23  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',23)->count();
      $c_count24  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',24)->count();
      $c_count25  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',25)->count();
      $c_count26  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',26)->count();
      $c_count27  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',27)->count();
      $c_count28  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',28)->count();
      $c_count29  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',29)->count();
      $c_count30  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',30)->count();
      $c_count31  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',31)->count();
      $c_count32  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',32)->count();
      $c_count33  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',33)->count();
      $c_count34  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_social')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_social',34)->count();
  ...
  public function obtenerVariablesEconomicas($option){
    ...
    if($option == "general"){
      ...
      $c_count35  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',35)->count();
      $c_count36  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',36)->count();
      $c_count37  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',37)->count();
      $c_count38  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',38)->count();
      $c_count39  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',39)->count();
      $c_count40  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',40)->count();
      $c_count41  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',41)->count();
      $c_count42  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',42)->count();
      $c_count43  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.tema_problematica_economico')->where('participacion.municipio_residencia',$option)->where('participacion.tema_problematica_economico',43)->count();
  ...
  public function obtenerQuestions($option){
    ...
    if($option == "general"){
      ...
      $count_Q_01_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_01')->where('participacion.municipio_residencia',$option)->where('participacion.Q_01','E')->count();
      $count_Q_01_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_01')->where('participacion.municipio_residencia',$option)->where('participacion.Q_01','B')->count();
      $count_Q_01_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_01')->where('participacion.municipio_residencia',$option)->where('participacion.Q_01','M')->count();
      $count_Q_01_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_01')->where('participacion.municipio_residencia',$option)->where('participacion.Q_01','NE')->count();
      //Question 2
      $count_Q_02_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_02')->where('participacion.municipio_residencia',$option)->where('participacion.Q_02','E')->count();
      $count_Q_02_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_02')->where('participacion.municipio_residencia',$option)->where('participacion.Q_02','B')->count();
      $count_Q_02_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_02')->where('participacion.municipio_residencia',$option)->where('participacion.Q_02','M')->count();
      $count_Q_02_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_02')->where('participacion.municipio_residencia',$option)->where('participacion.Q_02','NE')->count();
      //Question 3
      $count_Q_03_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_03')->where('participacion.municipio_residencia',$option)->where('participacion.Q_03','E')->count();
      $count_Q_03_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_03')->where('participacion.municipio_residencia',$option)->where('participacion.Q_03','B')->count();
      $count_Q_03_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_03')->where('participacion.municipio_residencia',$option)->where('participacion.Q_03','M')->count();
      $count_Q_03_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_03')->where('participacion.municipio_residencia',$option)->where('participacion.Q_03','NE')->count();
      //Question 4
      $count_Q_04_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_04')->where('participacion.municipio_residencia',$option)->where('participacion.Q_04','E')->count();
      $count_Q_04_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_04')->where('participacion.municipio_residencia',$option)->where('participacion.Q_04','B')->count();
      $count_Q_04_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_04')->where('participacion.municipio_residencia',$option)->where('participacion.Q_04','M')->count();
      $count_Q_04_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_04')->where('participacion.municipio_residencia',$option)->where('participacion.Q_04','NE')->count();
      //Question 5
      $count_Q_05_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_05')->where('participacion.municipio_residencia',$option)->where('participacion.Q_05','E')->count();
      $count_Q_05_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_05')->where('participacion.municipio_residencia',$option)->where('participacion.Q_05','B')->count();
      $count_Q_05_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_05')->where('participacion.municipio_residencia',$option)->where('participacion.Q_05','M')->count();
      $count_Q_05_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_05')->where('participacion.municipio_residencia',$option)->where('participacion.Q_05','NE')->count();
      //Question 6
      $count_Q_06_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_06')->where('participacion.municipio_residencia',$option)->where('participacion.Q_06','E')->count();
      $count_Q_06_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_06')->where('participacion.municipio_residencia',$option)->where('participacion.Q_06','B')->count();
      $count_Q_06_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_06')->where('participacion.municipio_residencia',$option)->where('participacion.Q_06','M')->count();
      $count_Q_06_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_06')->where('participacion.municipio_residencia',$option)->where('participacion.Q_06','NE')->count();
      //Question 7
      $count_Q_07_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_07')->where('participacion.municipio_residencia',$option)->where('participacion.Q_07','E')->count();
      $count_Q_07_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_07')->where('participacion.municipio_residencia',$option)->where('participacion.Q_07','B')->count();
      $count_Q_07_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_07')->where('participacion.municipio_residencia',$option)->where('participacion.Q_07','M')->count();
      $count_Q_07_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_07')->where('participacion.municipio_residencia',$option)->where('participacion.Q_07','NE')->count();
      //Question 8
      $count_Q_08_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_08')->where('participacion.municipio_residencia',$option)->where('participacion.Q_08','E')->count();
      $count_Q_08_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_08')->where('participacion.municipio_residencia',$option)->where('participacion.Q_08','B')->count();
      $count_Q_08_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_08')->where('participacion.municipio_residencia',$option)->where('participacion.Q_08','M')->count();
      $count_Q_08_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_08')->where('participacion.municipio_residencia',$option)->where('participacion.Q_08','NE')->count();
      //Question 9
      $count_Q_09_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_09')->where('participacion.municipio_residencia',$option)->where('participacion.Q_09','E')->count();
      $count_Q_09_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_09')->where('participacion.municipio_residencia',$option)->where('participacion.Q_09','B')->count();
      $count_Q_09_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_09')->where('participacion.municipio_residencia',$option)->where('participacion.Q_09','M')->count();
      $count_Q_09_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_09')->where('participacion.municipio_residencia',$option)->where('participacion.Q_09','NE')->count();
      //Question10
      $count_Q_10_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_10')->where('participacion.municipio_residencia',$option)->where('participacion.Q_10','E')->count();
      $count_Q_10_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_10')->where('participacion.municipio_residencia',$option)->where('participacion.Q_10','B')->count();
      $count_Q_10_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_10')->where('participacion.municipio_residencia',$option)->where('participacion.Q_10','M')->count();
      $count_Q_10_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_10')->where('participacion.municipio_residencia',$option)->where('participacion.Q_10','NE')->count();
      //Question 11
      $count_Q_11_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_11')->where('participacion.municipio_residencia',$option)->where('participacion.Q_11','E')->count();
      $count_Q_11_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_11')->where('participacion.municipio_residencia',$option)->where('participacion.Q_11','B')->count();
      $count_Q_11_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_11')->where('participacion.municipio_residencia',$option)->where('participacion.Q_11','M')->count();
      $count_Q_11_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_11')->where('participacion.municipio_residencia',$option)->where('participacion.Q_11','NE')->count();
      //Question 12
      $count_Q_12_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_12')->where('participacion.municipio_residencia',$option)->where('participacion.Q_12','E')->count();
      $count_Q_12_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_12')->where('participacion.municipio_residencia',$option)->where('participacion.Q_12','B')->count();
      $count_Q_12_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_12')->where('participacion.municipio_residencia',$option)->where('participacion.Q_12','M')->count();
      $count_Q_12_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_12')->where('participacion.municipio_residencia',$option)->where('participacion.Q_12','NE')->count();
      //Question 13
      $count_Q_13_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_13')->where('participacion.municipio_residencia',$option)->where('participacion.Q_13','E')->count();
      $count_Q_13_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_13')->where('participacion.municipio_residencia',$option)->where('participacion.Q_13','B')->count();
      $count_Q_13_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_13')->where('participacion.municipio_residencia',$option)->where('participacion.Q_13','M')->count();
      $count_Q_13_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_13')->where('participacion.municipio_residencia',$option)->where('participacion.Q_13','NE')->count();
      //Question 14
      $count_Q_14_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_14')->where('participacion.municipio_residencia',$option)->where('participacion.Q_14','E')->count();
      $count_Q_14_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_14')->where('participacion.municipio_residencia',$option)->where('participacion.Q_14','B')->count();
      $count_Q_14_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_14')->where('participacion.municipio_residencia',$option)->where('participacion.Q_14','M')->count();
      $count_Q_14_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_14')->where('participacion.municipio_residencia',$option)->where('participacion.Q_14','NE')->count();
      //Question 15
      $count_Q_15_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_15')->where('participacion.municipio_residencia',$option)->where('participacion.Q_15','E')->count();
      $count_Q_15_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_15')->where('participacion.municipio_residencia',$option)->where('participacion.Q_15','B')->count();
      $count_Q_15_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_15')->where('participacion.municipio_residencia',$option)->where('participacion.Q_15','M')->count();
      $count_Q_15_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_15')->where('participacion.municipio_residencia',$option)->where('participacion.Q_15','NE')->count();
      //Question 16
      $count_Q_16_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_16')->where('participacion.municipio_residencia',$option)->where('participacion.Q_16','E')->count();
      $count_Q_16_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_16')->where('participacion.municipio_residencia',$option)->where('participacion.Q_16','B')->count();
      $count_Q_16_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_16')->where('participacion.municipio_residencia',$option)->where('participacion.Q_16','M')->count();
      $count_Q_16_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_16')->where('participacion.municipio_residencia',$option)->where('participacion.Q_16','NE')->count();
      //Question 17
      $count_Q_17_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_17')->where('participacion.municipio_residencia',$option)->where('participacion.Q_17','E')->count();
      $count_Q_17_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_17')->where('participacion.municipio_residencia',$option)->where('participacion.Q_17','B')->count();
      $count_Q_17_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_17')->where('participacion.municipio_residencia',$option)->where('participacion.Q_17','M')->count();
      $count_Q_17_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_17')->where('participacion.municipio_residencia',$option)->where('participacion.Q_17','NE')->count();
      //Question 18
      $count_Q_18_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_18')->where('participacion.municipio_residencia',$option)->where('participacion.Q_18','E')->count();
      $count_Q_18_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_18')->where('participacion.municipio_residencia',$option)->where('participacion.Q_18','B')->count();
      $count_Q_18_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_18')->where('participacion.municipio_residencia',$option)->where('participacion.Q_18','M')->count();
      $count_Q_18_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_18')->where('participacion.municipio_residencia',$option)->where('participacion.Q_18','NE')->count();
      //Question 19
      $count_Q_19_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_19')->where('participacion.municipio_residencia',$option)->where('participacion.Q_19','E')->count();
      $count_Q_19_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_19')->where('participacion.municipio_residencia',$option)->where('participacion.Q_19','B')->count();
      $count_Q_19_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_19')->where('participacion.municipio_residencia',$option)->where('participacion.Q_19','M')->count();
      $count_Q_19_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_19')->where('participacion.municipio_residencia',$option)->where('participacion.Q_19','NE')->count();
      //Question 20
      $count_Q_20_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_20')->where('participacion.municipio_residencia',$option)->where('participacion.Q_20','E')->count();
      $count_Q_20_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_20')->where('participacion.municipio_residencia',$option)->where('participacion.Q_20','B')->count();
      $count_Q_20_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_20')->where('participacion.municipio_residencia',$option)->where('participacion.Q_20','M')->count();
      $count_Q_20_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_20')->where('participacion.municipio_residencia',$option)->where('participacion.Q_20','NE')->count();
      //Question 21
      $count_Q_21_E  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_21')->where('participacion.municipio_residencia',$option)->where('participacion.Q_21','E')->count();
      $count_Q_21_B  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_21')->where('participacion.municipio_residencia',$option)->where('participacion.Q_21','B')->count();
      $count_Q_21_M  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_21')->where('participacion.municipio_residencia',$option)->where('participacion.Q_21','M')->count();
      $count_Q_21_NE  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.Q_21')->where('participacion.municipio_residencia',$option)->where('participacion.Q_21','NE')->count();
  ...
  public function obtenerMapaGeneral(){
    ...
    $social  = \DB::table('participaciones_recoleccion as participacion')
              ->select('participacion.ubicacion_latitud_social as latitud','participacion.ubicacion_longitud_social as longitud','participacion.municipio_residencia as municipio','participacion.nombres_apellidos as nombres')
              ->get();
    $economico  = \DB::table('participaciones_recoleccion as participacion')
              ->select('participacion.ubicacion_latitud_economico as latitud','participacion.ubicacion_longitud_economico as longitud','participacion.municipio_residencia as municipio','participacion.nombres_apellidos as nombres')
              ->get();

    $ambiental  = \DB::table('participaciones_recoleccion as participacion')
              ->select('participacion.ubicacion_latitud_ambiental as latitud','participacion.ubicacion_longitud_ambiental as longitud','participacion.municipio_residencia as municipio','participacion.nombres_apellidos as nombres')
              ->get();
  ...
  public function obtenerSectorPertenece($option){
    ...
    if($option == "general"){
      ...
      $c_ninguno = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Ninguno')->count();
      $c_transporte_vias = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Transporte y vias')->count();
      $c_gremios = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Gremios')->count();
      $c_medio_ambiente = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Medio ambiente y desarrollo')->count();
      $c_infraestructura = \DB::table('participaciones_recoleccion as participacion')->select('participacion.sector_pertenece')->where('participacion.municipio_residencia',$option)->where('participacion.sector_pertenece','Infraestructura y servicios publicos')->count();
  ...
  public function obtenerSituacionDesplazamiento($option){
    ...
    if($option == "general"){
      ...
      $c_desplazado = \DB::table('participaciones_recoleccion as participacion')->select('participacion.id')->where('participacion.municipio_residencia',$option)->where('participacion.situacion_dezplazamiento_conflicto',1)->count();
      $c_nodesplazado  = \DB::table('participaciones_recoleccion as participacion')->select('participacion.id')->where('participacion.municipio_residencia',$option)->where('participacion.situacion_dezplazamiento_conflicto',0)->count();
    }
